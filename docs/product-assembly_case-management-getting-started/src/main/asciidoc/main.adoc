...
* {PRODUCT} is installed and configured with {KIE_SERVER}. For more information see _Getting started with {PRODUCT}_.
//xreflink 
...
include::case-management-deploy-itorders-in-showcase-proc.adoc[leveloffset=+2]
